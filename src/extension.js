...
import {Fulu, ExtensionBase, Destroyable, manageSource, omit, _, getSelf, copy, paste} from './fubar.js';
...
class ColorArea extends St.Widget {
    ...
    async _buildWidgets() {
        manageSource(this, () => omit(this, 'preview', '_pointer'));
...
class ColorPicker extends Destroyable {
    ...
    _buildWidgets(gset) {
        ...
        this._src = manageSource(this, () => omit(this, 'dbus', 'systray', '_area'), {
